...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8501","http://localhost:3000/style-test","http://localhost:3000","http://35.202.213.228:3000","http://35.202.213.228:8501",
                   "http://34.63.190.7", "http://34.63.190.7:80", "http://34.63.190.7:8000"],  # Streamlit default port
